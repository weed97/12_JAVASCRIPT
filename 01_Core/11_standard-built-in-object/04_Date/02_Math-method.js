...
// Date.UTC : 1970년 1월 1일 00:00:00(UTC)를 기점으로 인수로 전달 된 지정 시간까지의 밀리초를 숫자로 반환한다
...
console.log(date.getDay());             // 일요일 부터 월요일을 0~6으로 반환
...
// : 1970년 1월 1일 00:00:00(UTC)을 기점으로 경과된 미릴초 반환, 설정
