...
// 2. new Date(milliseconds) : 1970년 1월 1일 00:00:00(UTC)를 기점으로 인수 전달 된 밀리초만큼 경과한 날짜와 시간을 나타내느 Date 객체 반환
console.log(new Date(0));
console.log(new Date(24 * 60 * 60 * 1000));

// 3. new Date(dataString) : 날짜와 시간을 나타내는 문자열을 인수로 전달하면 지정 된 날짜와 시간을 나타내는 Date 객체 반환
