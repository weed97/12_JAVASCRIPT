...
console.log(Number.MIN_VALUE > 0); // 0 보다 크다
...
// Number.NaN : 숫자가 아니을 나타내는 숫자값
console.log(Number.NaN);

//Number.EPSILON : 부동 소수점으로 인해 발생하는 오차를 해결하기 위해 사용한다
console.log(Number.EPSILON); // 1과 1보다 큰 숫자 중에서 가장 가장 작은 숫자와의 차이와 같다
console.log(0.1 + 0.2);      // 부동소수점 표현은 2진범으로 변환했을 떄 무한소수가 되어 미세한 오차가 발생할 수 밖에 없다
console.log(0.1 + 0.2 === 0.3);     // false;
console.log(isFinite(0.1 + 0.2, 0.3)); // true
