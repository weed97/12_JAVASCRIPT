...
// String은 생성자 함수 객체다. new 연산자와 함꼐 호출하여 String 인스턴스를 생성한다.
const obj = new String();
console.log(obj);           // 인수 전달하지 않으면 빈 문자열을 할당한 객체 생성

const obj2 = new String('홍길동');
console.log(obj2);          // 인수 문자열 전달 시 전달 받은 문자열 할당
...
// 명시적 타입 형변환에 활용 가능 (02_variable > 04_explict-coercion > 01_covert-to-string)
